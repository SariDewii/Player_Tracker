...
public class TrackCMD implements CommandExecutor {
    ...
    void printHelp(CommandSender s) {
        s.sendMessage(Main.prefix + ChatColor.YELLOW + "/track give <player> - Gives a track to your inventory / other player's");
        s.sendMessage(Main.prefix + ChatColor.YELLOW + "/track reload - Reload configuration files for Tracker");
    }
}
